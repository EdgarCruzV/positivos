...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dayNight = (Switch) findViewById(R.id.switch1);
        dayNight.setText("Día/Noche");
        ...
        Toast.makeText( this,"MENSAJES POSITIVOS", Toast.LENGTH_LONG).show();
        Log.i(TAG,"Welcome");

        dayNight.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                mainLayout = (ConstraintLayout) findViewById(R.id.pantalla);
                if (isChecked) {
                    mainLayout.setBackgroundColor(Color.BLACK);
                    textView.setTextColor(Color.WHITE);
                    editText.setTextColor(Color.WHITE);
                    dayNight.setTextColor(Color.WHITE);
                }
                else {
                    mainLayout.setBackgroundColor(Color.WHITE);
                    textView.setTextColor(Color.BLACK);
                    editText.setTextColor(Color.BLACK);
                    dayNight.setTextColor(Color.BLACK);
                }
            }
        });
    }
    public void enter(android.view.View view){
        ...
        if(number <= min){
            Toast.makeText(this, "The number entered must be greater than zero", Toast.LENGTH_LONG).show();
        }else if(number > max){
            Toast.makeText(this, "The number entered exceed the data base length", Toast.LENGTH_LONG).show();
        }else{
            textView.setText(mensajes[(number - 1)]);
        }
    }
    public void siguiente(android.view.View view){
